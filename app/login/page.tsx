  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-black">
      ...
      <div className="m-auto w-full max-w-md p-6 bg-white dark:bg-gray-900 shadow rounded-lg">
        ...
        <div className="mt-6">
          <Button className="w-full rounded-md bg-indigo-600 cursor-pointer py-2 px-4 text-white hover:bg-indigo-700 dark:hover:bg-indigo-800">
            Login
          </Button>
        </div>
        ...
        <div className="mt-6">
          <Link href="/register">
            <Button className=" cursor-pointer w-full rounded-md bg-blue-600 py-2 px-4 text-white hover:bg-blue-700 dark:hover:bg-blue-800">
              Create Account
            </Button>
          </Link>
        </div>
